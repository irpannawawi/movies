...
return [
    ...
    'title' => [
         ...
         */
        'homepage_title' => 'InFlix - Tempat nonton Film & Acara TV Tanpa Batas hanya di '.env('APP_NAME'),
    ],
    ...
    'description' => [
         ...
         */
        'fallback' => 'Tempat nonton Film & Acara TV Tanpa Batas | Streaming Konten HD hanya di '.env('APP_NAME'),
    ],
